...
interface ExtendedSidebarProps
  extends Omit<
    SidebarProps,
    "isCollapsed" | "toggleSidebar" | "onSettingsClick" | "onProfileClick"
  > {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col mt-4 overflow-hidden">
        {showThreadMessaging && activeView === PLUGIN_NAME_ENUM.CHAT ? (
          <>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        {unreadCounts[agent.agent_id] > 0 && (
                          <span className="ml-2 bg-red-500 text-white text-xs rounded-full px-1.5 py-0.5 min-w-[1.25rem] text-center">
                            {unreadCounts[agent.agent_id] > 99
                              ? "99+"
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-xs opacity-75 ml-6">
                              <div className="truncate">
                                v{doc.version} • {doc.creator}
                              </div>
                              <div className="mt-0.5">
                                {formatRelativeDate(doc.last_modified)}
                              </div>
                            </div>
                          </div>
      ...
      {hasSharedDocuments && (
        <div className="px-4 pt-2">
          <button
            onClick={() => setActiveView(PLUGIN_NAME_ENUM.DOCUMENTS)}
      ...
      <div className="px-4 pt-2">
        <button
          onClick={() => setActiveView(PLUGIN_NAME_ENUM.MCP)}
          className={`relative group flex items-center w-full rounded-lg px-4 py-3.5 text-sm transition-all overflow-hidden
              ${
                activeView === "mcp"
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          >
            {currentTheme === "light" ? (
              ...
              <svg
                className="w-4 h-4 text-gray-300 group-hover:text-gray-100 transition-colors"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
