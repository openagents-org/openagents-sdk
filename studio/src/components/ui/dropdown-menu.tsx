  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        'focus:bg-accent focus:text-foreground focus:outline-none focus:ring-0 focus:border-0',
        'data-[active=true]:bg-accent data-[active=true]:text-accent-foreground data-[active=true]:border-0',
        'data-[here]:border-0 data-[highlighted]:border-0 hover:border-0',
        inset && 'ps-8',
        variant === 'destructive' &&
