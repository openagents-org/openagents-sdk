...
class NetworkConnector(ABC):
    ...
    def __init__(self, host: str, port: int, agent_id: str, metadata: Optional[Dict[str, Any]] = None):
        ...
        self.is_polling = False  # Whether this connector uses polling for message retrieval
    ...
    def _create_success_response(self, message: str = "Success", data: Any = None) -> EventResponse:
