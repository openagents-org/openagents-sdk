...
class DefaultProjectAgentAdapter(BaseModAdapter):
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "notification_type": {
                            ...
                            "enum": ["progress", "completion", "error", "input_required"]
                        },
                        "content": {
                            "type": "object",
    ...
    async def start_project(self, goal: str, name: Optional[str] = None, 
    ...
    async def send_project_notification(self, project_id: str, notification_type: str,
                                      content: Dict[str, Any], target_agent_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def _change_project_status(self, project_id: str, action: str) -> Dict[str, Any]:
    ...
    async def _send_and_wait_for_response(self, message, timeout: float = 10.0) -> Optional[Dict[str, Any]]:
    ...
    async def _handle_project_notification(self, content: Dict[str, Any]) -> None:
        ...
        logger.info(f"Received project notification: {notification_type} for project {project_name} ({project_id})")
    ...
    async def _handle_project_message(self, content: Dict[str, Any]) -> None:
        ...
        logger.info(f"Received project message for project {project_id}: {original_message}")
