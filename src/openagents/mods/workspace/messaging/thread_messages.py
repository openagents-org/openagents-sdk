...
class ChannelMessage:
    ...
    def validate(cls, event: Event) -> Event:
        ...
        if 'mentioned_agent_id' in payload and payload['mentioned_agent_id'] is not None:
    ...
    @classmethod
    def create(cls, channel: str, text: str, source_id: str, 
...
class ReplyMessage:
    ...
    @classmethod
    def create(cls, reply_to_id: str, text: str, source_id: str,
...
class FileUploadMessage:
    ...
    @classmethod
    def create(cls, filename: str, file_content: str, source_id: str,
    ...
    def get_mime_type(event: Event) -> str:
        ...
        return event.payload.get("mime_type", "application/octet-stream") if event.payload else "application/octet-stream"
...
class FileOperationMessage:
    ...
    def validate(cls, event: Event) -> Event:
        ...
        if not action:
            raise ValueError(f"Could not infer action from event name: {event.event_name}")
    ...
    @classmethod
    def create(cls, action: str, source_id: str, file_id: Optional[str] = None, **kwargs) -> Event:
        ...
        event_name = kwargs.pop("event_name", event_name_map.get(action, "thread.file.operation_requested"))
...
class ChannelInfoMessage:
    ...
    @classmethod
    def create(cls, source_id: str, action: str = "list_channels", request_id: Optional[str] = None, **kwargs) -> Event:
...
class MessageRetrievalMessage:
    ...
    @classmethod
    def create(cls, action: str, source_id: str, channel: Optional[str] = None, 
               target_agent_id: Optional[str] = None, limit: int = 50, offset: int = 0, 
               include_threads: bool = True, request_id: Optional[str] = None, **kwargs) -> Event:
        ...
        event_name = kwargs.pop("event_name", event_name_map.get(action, "thread.messages.retrieval_requested"))
...
class ReactionMessage:
    ...
    def validate(cls, event: Event) -> Event:
        ...
        if not target_message_id:
            raise ValueError("Reaction message must have 'target_message_id' in payload")
    ...
    @classmethod
    def create(cls, target_message_id: str, reaction_type: str, source_id: str, 
               action: str = "add", request_id: Optional[str] = None, **kwargs) -> Event:
        ...
        event_name = kwargs.pop("event_name", event_name_map.get(action, "thread.reaction.updated"))
