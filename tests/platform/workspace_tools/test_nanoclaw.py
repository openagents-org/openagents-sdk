"""
Platform workspace tools tests for NanoClaw agent.

Tests that the MCP server correctly exposes workspace tools.
Verifies the tool registry since the same MCP server powers all
agent types.

Run:
    pytest tests/platform/workspace_tools/test_nanoclaw.py -v
"""
...
class TestNanoClawWorkspaceToolsReport:
