"""
Platform respond tests for OpenClaw agent.

Tests that an OpenClaw agent connected to a workspace can receive
...
class TestOpenClawRespond:
    """Test sending messages to a workspace with OpenClaw."""
