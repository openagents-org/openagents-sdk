...
async def test_file_upload_grpc(grpc_client_alice):
    ...
    assert upload_data["filename"] == "grpc_test_document.txt", "Upload response should contain correct filename"
...
This tests the complete upload/download workflow."""
    ...
    assert upload_data["success"] == True, "File upload should be successful"
    assert "file_id" in upload_data, "Upload response should contain file_id"
    assert upload_data["filename"] == "grpc_comprehensive_test.txt", "Upload response should contain correct filename"
    ...
    file_download = Event(
        ...
        payload={
            "file_id": file_id,
            "test_id": "grpc_comprehensive_download_test"
        },
    ...
    assert download_data["filename"] == "grpc_comprehensive_test.txt", "Download response should contain correct filename"
...
async def test_file_download_nonexistent_file_grpc(grpc_client_bob):
    ...
    file_download = Event(
        ...
        payload={
            ...
            "test_id": "grpc_nonexistent_file_test"
        },
...
async def test_large_file_operations_grpc(grpc_client_alice, grpc_client_bob):
    ...
    file_download = Event(
        ...
        payload={
            "file_id": file_id,
            "test_id": "grpc_large_file_download_test"
        },
